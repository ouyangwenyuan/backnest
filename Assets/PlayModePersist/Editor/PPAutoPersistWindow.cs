...
{
    static bool SHOW_ADDED_ALL = false; //turn this to true, to show add all button (added every component has significant editor performance overhead and may not achieve your desired result)
